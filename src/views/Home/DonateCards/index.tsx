    ...
    <section className='py-14 lg:py-28'>
      <div className='container'>
        ...
        <div className='mt-8 lg:mt-12 grid grid-rows-[auto] md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-11'>
          <div className='bg-white shadow-lg rounded-xl p-10 lg:px-12 lg:py-[3.375rem] lg:pb-12 flex flex-col'>
          ...
          <div className={classNames('shadow-lg rounded-xl p-10 lg:px-12 lg:py-[3.375rem] lg:pb-12 flex flex-col', styles.orangeCard)}>
          ...
          <div className='bg-white shadow-lg rounded-xl p-10 lg:px-12 lg:py-[3.375rem] lg:pb-12 flex flex-col md:col-span-2 lg:col-span-1'>
            <div className='bg-[#ebebeb] w-20 h-20 rounded-full flex items-center justify-center'>
              <Image 
                src={FlowerIcon}
                alt="Flower Icon"
